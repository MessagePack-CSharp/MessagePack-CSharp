					...
					case 1:
					    switch (global::MessagePack.Internal.AutomataKeyGen.GetKey(ref stringKey))
					    {
    					    ...
    					    case 65UL:
        					    ...
        					    continue;
    					    case 66UL:
        					    ____result.B = MsgPack::FormatterResolverExtensions.DeserializeWithVerifyByValue<string>(ref reader, options);
        					    continue;
					    }
					...
					case 1:
					    switch (global::MessagePack.Internal.AutomataKeyGen.GetKey(ref stringKey))
					    {
    					    ...
    					    case 65UL:
        					    ...
        					    continue;
    					    case 66UL:
        					    ____result.B = MsgPack::FormatterResolverExtensions.DeserializeWithVerifyInto<string>(ref reader, ____result.B, options);
        					    continue;
					    }
