...
partial class GeneratedMessagePackResolver : MsgPack::IFormatterResolver
{
	...
	private static class GeneratedMessagePackResolverGetFormatterHelper
	{
		...
		{
			{ typeof(global::TempProject.Item<int>), 0 },
			{ typeof(global::TempProject.Cmd), 1 },
		};
		...
		{
			{ typeof(global::TempProject.Item<>), 0 },
		};
		...
		internal static object GetFormatter(global::System.Type t)
		{
			if (closedTypeLookup.TryGetValue(t, out int closedKey))
			{
				switch (closedKey)
				{
					case 0: return new global::MessagePack.GeneratedMessagePackResolver.TempProject.ItemFormatter<int>();
					case 1: return new global::MessagePack.GeneratedMessagePackResolver.TempProject.CmdFormatter();
			...
			if (t.IsGenericType && openTypeLookup.TryGetValue(t.GetGenericTypeDefinition(), out int openKey))
			{
				switch (openKey)
				{
					case 0: return global::System.Activator.CreateInstance(typeof(global::MessagePack.GeneratedMessagePackResolver.TempProject.ItemFormatter<>).MakeGenericType(t.GenericTypeArguments));
					default: return null; // unreachable
				};
			}
