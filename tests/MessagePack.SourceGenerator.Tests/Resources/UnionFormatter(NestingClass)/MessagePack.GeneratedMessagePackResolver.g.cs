...
namespace MessagePack
{
	...
	internal static class GeneratedMessagePackResolverGetFormatterHelper
	{
		...
		internal static object GetFormatter(global::System.Type t)
		{
			...
			switch (key)
			{
				case 0: return new Formatters::IMyTypeFormatter();
				case 1: return new Formatters::ContainingClass_Derived1Formatter();
				case 2: return new Formatters::ContainingClass_Derived2Formatter();
				case 3: return new Formatters::ContainingClass_MyMessagePackObjectFormatter();
				default: return null;
			}
		}
	}
