...
""";
        await VerifyCS.Test.RunDefaultAsync(testSource, options: AnalyzerOptions.Default with { AdditionalAllowTypes = ImmutableHashSet<string>.Empty.Add("MyCustomType") });
    }
}
