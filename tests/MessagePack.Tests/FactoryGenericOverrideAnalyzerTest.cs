...
public class FactoryGenericOverrideAnalyzerTest
{
    ...
    const string TypeBasedOnlySource = """
        public sealed class OnlyTypeBasedFactory : MessagePack.MessagePackFormatterFactory
        {
    ...
    public async Task TypeBasedOnlyOnModernSurface_Reports()
    {
        ...
        // the bridge — exactly what MsgPack102 exists to surface
    ...
    {
        const string source = """
            public sealed class FullFactory : MessagePack.MessagePackFormatterFactory
            {
