...
#if V3COMPAT_EXCLUDED // V3COMPAT-EDIT: v3-style IMessagePackFormatter<T> (v4 formatters are buffer-generic)
...
{
    // V3COMPAT-EDIT: v3 NativeDateTimeFormatter; v4's per-member [MessagePackFormatter] takes a factory, and the
    // equivalent wire form lives in the DotNetOptimized chain — dropped to keep the type compiling
    [Key(0)]
