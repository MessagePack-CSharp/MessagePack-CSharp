...
namespace MessagePack.Tests
{
    public class LZ4Test
    {
...
#if V3COMPAT_EXCLUDED // V3COMPAT-EDIT: v3 SequencePool/WithPool plumbing; v4 options have no pool knob
        [Theory]
        ...
        public void Lz4BlockRejectsTruncatedLiteralRun()
        {
            ...
            var options = MessagePackSerializerOptions.Default.WithCompression(MessagePackCompression.Lz4Block);
        ...
        private void Execute(int count)
        {
            // Large
            {
                ...
                var lz4Option = MessagePackSerializerOptions.Default.WithCompression(MessagePackCompression.Lz4Block);
                var lz4Contiguous = MessagePackSerializerOptions.Default.WithCompression(MessagePackCompression.Lz4BlockArray);
...
#if !UNITY_2018_3_OR_NEWER
                var bin1 = MessagePackSerializer.Serialize(data, MessagePackSerializerOptions.Default.WithCompression(MessagePackCompression.None));
