...
namespace MessagePack.Tests
{
    public class PrimitiveResolverTest
    {
        ...
        [Fact(Skip = "v4 intentional: boxed primitives write forced-width codes so the .NET type round-trips exactly; v3's compact write made 999 (int) come back as UInt16")]
