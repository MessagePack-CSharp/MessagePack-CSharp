...
namespace MessagePack.Tests
{
    public class ObjectResolverTest
    {
        ...
        public void MoreEmpty()
        {
            ...
            V3JsonCompat.SerializeToJson(e1).Is("[]");
            V3JsonCompat.SerializeToJson(e2).Is("{}");
            V3JsonCompat.SerializeToJson(ne1).Is("[0]");
            V3JsonCompat.SerializeToJson(ne2).Is(@"{""MyProperty"":0}");
        }
