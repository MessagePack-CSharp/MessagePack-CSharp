...
namespace MessagePack.Tests
{
    public class StringInterningTests
    {
        ...
        public void NullString()
        {
            ...
            string result = StandardResolver.Instance.GetFormatter<string>().Deserialize(ref reader, MessagePackSerializerOptions.Default);
            Assert.Null(result);
        }
        ...
        public void EquivalentStringsGetSharedInstance(int length)
        {
            ...
            string value1 = formatter.Deserialize(ref reader, MessagePackSerializerOptions.Default);
            string value2 = formatter.Deserialize(ref reader, MessagePackSerializerOptions.Default);
            string value3 = formatter.Deserialize(ref reader, MessagePackSerializerOptions.Default);
        ...
        public void StringMemberInterning()
        {
            ...
            ClassOfStrings after1 = MessagePackSerializer.Deserialize<ClassOfStrings>(MessagePackSerializer.Serialize(before, MessagePackSerializerOptions.Default), MessagePackSerializerOptions.Default);
            ClassOfStrings after2 = MessagePackSerializer.Deserialize<ClassOfStrings>(MessagePackSerializer.Serialize(before, MessagePackSerializerOptions.Default), MessagePackSerializerOptions.Default);
        ...
        {
            var options = MessagePackSerializerOptions.Default.WithResolver(
