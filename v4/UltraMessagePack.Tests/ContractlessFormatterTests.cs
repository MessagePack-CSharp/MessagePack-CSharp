...
public class ContractlessFormatterTests
{
    ...
    [Fact]
    public void MissingCtorParameterKey_BecomesDefault()
    {
    ...
    {
        var v3Options = MessagePack.Resolvers.ContractlessStandardResolver.Options;
        var record = new RecordPerson(31, "rv3");

        Assert.Equal(record, MessagePackSerializer.Deserialize<RecordPerson>(
            MessagePack.MessagePackSerializer.Serialize(record, v3Options), options));
        Assert.Equal(record, MessagePack.MessagePackSerializer.Deserialize<RecordPerson>(
    ...
    public void CrossCompatible_WithV3ContractlessStandardResolver()
    {
        ...
        var fromV3 = MessagePackSerializer.Deserialize<Person>(
            MessagePack.MessagePackSerializer.Serialize(person, v3Options), options)!;
        ...
        var fromUmp = MessagePack.MessagePackSerializer.Deserialize<Person>(
    ...
    {
        var v3Options = MessagePack.MessagePackSerializerOptions.Standard.WithResolver(
        ...
        var fromV3 = MessagePackSerializer.Deserialize<PrivateState>(
            MessagePack.MessagePackSerializer.Serialize(value, v3Options), allowPrivateOptions)!;
        Assert.Equal((9, "v3", 55), fromV3.Snapshot());

        var fromUmp = MessagePack.MessagePackSerializer.Deserialize<PrivateState>(
