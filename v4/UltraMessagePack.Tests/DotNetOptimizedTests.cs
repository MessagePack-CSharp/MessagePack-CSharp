    ...
    static MessagePack.MessagePackSerializerOptions OracleOptions { get; } =
        MessagePack.MessagePackSerializerOptions.Standard.WithResolver(
            MessagePack.Resolvers.CompositeResolver.Create(
                [
                    MessagePack.Formatters.NativeGuidFormatter.Instance,
                    MessagePack.Formatters.NativeDecimalFormatter.Instance,
                    MessagePack.Formatters.NativeDateTimeFormatter.Instance,
                ],
