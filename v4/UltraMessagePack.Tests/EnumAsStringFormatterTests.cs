    ...
    static MessagePack.MessagePackSerializerOptions OracleOptions(bool ignoreCase = false) =>
        MessagePack.MessagePackSerializerOptions.Standard.WithResolver(
            CompositeResolver.Create(
                [
                    new MessagePack.Formatters.EnumAsStringFormatter<Simple>(ignoreCase),
                    new MessagePack.Formatters.EnumAsStringFormatter<Renamed>(ignoreCase),
                    new MessagePack.Formatters.EnumAsStringFormatter<FlagsRenamed>(ignoreCase),
                ],
