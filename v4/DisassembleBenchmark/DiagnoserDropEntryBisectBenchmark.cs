...
public class DiagnoserDropEntryBisectBenchmark
{
    ...
    public byte[] UltraFull() => MessagePackSerializer.Serialize(person);
    ...
    static byte[] SerializeNoTry(BenchPerson value)
    {
        ...
        var state = new SerializeState();
        UltraMessagePack.MessagePackSerializerOptions.Default.Resolver.GetFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, BenchPerson>().Serialize(ref buffer, ref state, value);
