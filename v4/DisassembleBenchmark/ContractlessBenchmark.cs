...
public class ContractlessBenchmark
{
    ...
    UltraMessagePack.MessagePackSerializerOptions contractless = default!;
    UltraMessagePack.MessagePackSerializerOptions handMap = default!;
    MessagePack.MessagePackSerializerOptions v3Contractless = default!;
    ...
    public void Setup()
    {
        ...
        contractless = new UltraMessagePack.MessagePackSerializerOptions(
            new MessagePackFormatterResolver([UltraMessagePack.MessagePackFormatterFactory.Default.WithContractless()]));
        handMap = new UltraMessagePack.MessagePackSerializerOptions(new MessagePackFormatterResolver(
        [
            new HandMapPersonFormatterFactory(),
            BuiltInFormatterFactory.Instance,
            GenericFormatterFactory.Instance,
        ]));
        v3Contractless = MessagePack.Resolvers.ContractlessStandardResolver.Options;

        payload = UltraMessagePack.MessagePackSerializer.Serialize(person, contractless);
        ...
        if (!UltraMessagePack.MessagePackSerializer.Serialize(person, handMap).AsSpan().SequenceEqual(payload)) throw new InvalidOperationException("verify failed: handmap bytes vs contractless");
        var fromV3 = UltraMessagePack.MessagePackSerializer.Deserialize<ContractlessPerson>(
            MessagePack.MessagePackSerializer.Serialize(person, v3Contractless), contractless)!;
        ...
        var fromUmp = MessagePack.MessagePackSerializer.Deserialize<ContractlessPerson>(payload, v3Contractless);
        ...
        var roundTrip = UltraMessagePack.MessagePackSerializer.Deserialize<ContractlessPerson>(payload, handMap)!;
    ...
    public byte[] SerializeContractless() => UltraMessagePack.MessagePackSerializer.Serialize(person, contractless);

    [BenchmarkCategory("Serialize"), Benchmark]
    public byte[] SerializeHandMap() => UltraMessagePack.MessagePackSerializer.Serialize(person, handMap);

    [BenchmarkCategory("Serialize"), Benchmark]
    public byte[] SerializeV3Contractless() => MessagePack.MessagePackSerializer.Serialize(person, v3Contractless);

    [BenchmarkCategory("Deserialize"), Benchmark(Baseline = true)]
    public ContractlessPerson DeserializeContractless() => UltraMessagePack.MessagePackSerializer.Deserialize<ContractlessPerson>(payload, contractless)!;

    [BenchmarkCategory("Deserialize"), Benchmark]
    public ContractlessPerson DeserializeHandMap() => UltraMessagePack.MessagePackSerializer.Deserialize<ContractlessPerson>(payload, handMap)!;

    [BenchmarkCategory("Deserialize"), Benchmark]
    public ContractlessPerson DeserializeV3Contractless() => MessagePack.MessagePackSerializer.Deserialize<ContractlessPerson>(payload, v3Contractless);
    ...
    public void SetupFields()
    {
        ...
        fieldPayload = UltraMessagePack.MessagePackSerializer.Serialize(fieldPerson, contractless);

        var back = UltraMessagePack.MessagePackSerializer.Deserialize<FieldPerson>(fieldPayload, contractless);
        ...
        var v3Back = MessagePack.MessagePackSerializer.Deserialize<FieldPerson>(fieldPayload, v3Contractless);
    ...
    public byte[] SerializeContractlessFields() => UltraMessagePack.MessagePackSerializer.Serialize(fieldPerson, contractless);

    [BenchmarkCategory("SerializeFields"), Benchmark]
    public byte[] SerializeV3ContractlessFields() => MessagePack.MessagePackSerializer.Serialize(fieldPerson, v3Contractless);

    [BenchmarkCategory("DeserializeFields"), Benchmark(Baseline = true)]
    public FieldPerson DeserializeContractlessFields() => UltraMessagePack.MessagePackSerializer.Deserialize<FieldPerson>(fieldPayload, contractless);

    [BenchmarkCategory("DeserializeFields"), Benchmark]
    public FieldPerson DeserializeV3ContractlessFields() => MessagePack.MessagePackSerializer.Deserialize<FieldPerson>(fieldPayload, v3Contractless);
}
...
public sealed class HandMapPersonFormatter<TWriteBuffer, TReadBuffer> : UltraMessagePack.IMessagePackFormatter<TWriteBuffer, TReadBuffer, ContractlessPerson?>
    ...
    where TReadBuffer : struct, IReadBuffer, allows ref struct
{
    ...
    public void Serialize(ref TWriteBuffer buffer, ref UltraMessagePack.SerializeState state, ContractlessPerson? value)
    {
        if (value is null)
        {
            buffer.WriteNil();
    ...
    public void Deserialize(ref TReadBuffer buffer, ref UltraMessagePack.DeserializeState state, ref ContractlessPerson? value)
    {
...
public sealed partial class HandMapPersonFormatterFactory : UltraMessagePack.MessagePackFormatterFactory
{
