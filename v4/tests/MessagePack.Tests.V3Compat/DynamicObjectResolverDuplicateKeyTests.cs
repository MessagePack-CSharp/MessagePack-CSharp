...
namespace MessagePack.Tests
{
    public class DynamicObjectResolverDuplicateKeyTests : TestBase
    {
        ...
        private static void AssertDetectsDuplicateKey<T>()
        {
            ...
            // V3COMPAT-EDIT: v4 rejects at formatter construction with a clean MessagePackSerializationException
            // ("'T' declares key N more than once."); v3's TypeInitializationException was an IL-emit static-ctor artifact
            var ex = Assert.Throws<MessagePackSerializationException>(resolver.GetFormatterWithVerify<T>);
