...
namespace MessagePack.Tests
{
    public class NewGuidFormatterTest
    {
        ...
        {
#if V3COMPAT_EXCLUDED // V3COMPAT-EDIT: formatter-level round-trip of v3 GuidFormatter (v4's is buffer-generic; the serializer-level block below covers the wire behavior)
            {
                var original = Guid.NewGuid();
