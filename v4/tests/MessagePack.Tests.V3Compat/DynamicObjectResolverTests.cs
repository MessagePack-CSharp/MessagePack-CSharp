...
namespace MessagePack.Tests
{
    public class DynamicObjectResolverTests
    {
        ...
        public void TestMapModeAgainstVariousVisibility()
        {
            ...
            ClassWithUseMapAndMembersOfVariousVisibility deserialized = Roundtrip(original, MessagePackSerializerOptions.Default);
        ...
        public void TestMapModeAgainstVariousVisibility_AllowPrivateAttribute()
        {
            ...
            ClassWithUseMapAndMembersOfVariousVisibilityAllowPrivate deserialized = Roundtrip(original, MessagePackSerializerOptions.Default);
        ...
        [Fact(Skip = "v4 intentional: v3 rejected internal types without AllowPrivate because IL-emit could not access them; plain reflection has no such constraint, so the restriction is not carried over (migrating AllowPrivate code keeps working)")]
        public void InternalTypeWithPublicMembers()
        {
            ...
            Assert.Throws<MessagePackSerializationException>(() => MessagePackSerializer.Serialize(original, MessagePackSerializerOptions.Default));
        }
        ...
        {
            InternalTestWithoutMembersClass result = Roundtrip(new InternalTestWithoutMembersClass { BaseValue = 1 }, MessagePackSerializerOptions.Default);
