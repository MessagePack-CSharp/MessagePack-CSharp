// MsgPack104: PersonFormatter is a hand-written test fixture; the direct primitive calls are the exact shape under test.
...
public class CollectionAndObjectTests
{
    ...
    public void Int32Shapes_ResolveToTheSpecializedFormatters()
    {
        ...
        Assert.IsType<MessagePack.Formatters.PrimitiveArrayFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, int, Int32ElementCodec>>(
            resolver.GetFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, int[]>());
        Assert.IsType<MessagePack.Formatters.PrimitiveListFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, int, Int32ElementCodec>>(
        ...
        Assert.IsType<MessagePack.Formatters.PrimitiveMemoryFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, int, MessagePack.Formatters.Int32ElementCodec>>(
            resolver.GetFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, Memory<int>>());
        Assert.IsType<MessagePack.Formatters.PrimitiveReadOnlyMemoryFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, int, MessagePack.Formatters.Int32ElementCodec>>(
            resolver.GetFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, ReadOnlyMemory<int>>());
        Assert.IsType<MessagePack.Formatters.PrimitiveArraySegmentFormatter<ArrayPoolListWriteBuffer, ReadOnlySpanReadBuffer, int, MessagePack.Formatters.Int32ElementCodec>>(
    ...
    {
        SourceGeneratedFormatterFactory.Instance.Register(typeof(Person), new PersonFormatterFactory());
