...
public class WritePrimitiveTests
{
    ...
    public void ArrayHeader_MatchOracle()
    {
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteArrayHeader(count));
    ...
    public void MapHeader_MatchOracle()
    {
        foreach (var count in HeaderCounts)
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteMapHeader(count));
...
#pragma warning disable CA1857
        for (int count = 0; count <= 15; count++)
        {
            ...
            var mapOracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteMapHeader(count));
...
#pragma warning restore CA1857
    ...
    public void WriteForced_MatchOracle()
    {
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteInt8(v));
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteUInt8(v));
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteInt16(v));
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteUInt16(v));
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteInt32(v));
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteUInt32(v));
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteInt64(v));
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteUInt64(v));
    ...
    public void StringHeader_MatchOracle()
    {
        foreach (var count in HeaderCounts)
        {
            ...
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteStringHeader(count));
    ...
    public void BinHeader_MatchOracle()
    {
        foreach (var count in HeaderCounts)
        {
            ...
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteBinHeader(count));
    ...
    {
        Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteNil()), Ours(b => MessagePackPrimitives.UnsafeWriteNil(ref MemoryMarshal.GetArrayDataReference(b))));
        Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(true)), Ours(b => MessagePackPrimitives.UnsafeWriteBoolean(ref MemoryMarshal.GetArrayDataReference(b), true)));
        Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(false)), Ours(b => MessagePackPrimitives.UnsafeWriteBoolean(ref MemoryMarshal.GetArrayDataReference(b), false)));
        foreach (var f in (float[])[0f, 1.5f, -1.5f, float.NaN, float.PositiveInfinity, float.MaxValue, MathF.PI])
        {
            Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(f)), Ours(b => MessagePackPrimitives.UnsafeWriteSingle(ref MemoryMarshal.GetArrayDataReference(b), f)));
        }
        foreach (var d in (double[])[0, 1.5, -1.5, double.NaN, double.Epsilon, double.MaxValue, Math.PI])
        {
            Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(d)), Ours(b => MessagePackPrimitives.UnsafeWriteDouble(ref MemoryMarshal.GetArrayDataReference(b), d)));
        }
    }
    ...
    public void UInt32AndNarrow_MatchOracle()
    {
        ...
        {
            var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(v));
        ...
        {
            Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(v)), Ours(b => MessagePackPrimitives.UnsafeWriteUInt16(ref MemoryMarshal.GetArrayDataReference(b), v)));
        }
        foreach (var v in (byte[])[0, 127, 128, 255])
        {
            Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(v)), Ours(b => MessagePackPrimitives.UnsafeWriteByte(ref MemoryMarshal.GetArrayDataReference(b), v)));
        }
        foreach (var v in (sbyte[])[0, 1, -1, -32, -33, -128, 127])
        {
            Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(v)), Ours(b => MessagePackPrimitives.UnsafeWriteSByte(ref MemoryMarshal.GetArrayDataReference(b), v)));
        }
    }
    ...
    public void StringPrimitive_DirectCall_MatchOracle()
    {
        ...
        foreach (var v in values)
        {
            ...
            var oracle = V3::MessagePack.MessagePackSerializer.Serialize(v);
        ...
        Assert.Equal(V3::MessagePack.MessagePackSerializer.Serialize(bin), binBuf[..binLen]);
    }
    ...
    public void ExtHeader_MatchOracle()
    {
        ...
        foreach (var length in lengths)
        {
            foreach (var typeCode in typeCodes)
            {
                ...
                var oracle = OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.WriteExtensionFormatHeader(new V3::MessagePack.ExtensionHeader(typeCode, length)));
    ...
    public void Char_MatchOracle()
    {
        ...
        {
            Assert.Equal(OracleBytes((ref V3::MessagePack.MessagePackWriter w) => w.Write(v)), Ours(b => MessagePackPrimitives.UnsafeWriteChar(ref MemoryMarshal.GetArrayDataReference(b), v)));
        }
    }

    delegate void OracleWrite(ref V3::MessagePack.MessagePackWriter writer);

    static byte[] OracleBytes(OracleWrite write)
    {
        var output = new ArrayBufferWriter<byte>();
        var writer = new V3::MessagePack.MessagePackWriter(output);
        write(ref writer);
        writer.Flush();
