...
public class StringFormatterDispatchBenchmark
{
    ...
    public void Setup()
    {
        SourceGeneratedFormatterFactory.Instance.Register(typeof(SPersonDirect), new SPersonDirectFormatterFactory());
        SourceGeneratedFormatterFactory.Instance.Register(typeof(SPersonVia), new SPersonViaFormatterFactory());
