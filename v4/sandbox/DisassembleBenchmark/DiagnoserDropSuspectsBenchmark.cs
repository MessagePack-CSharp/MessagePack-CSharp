...
// all V4 benchmarks and MessagePack-CSharp Deserialize fail; MessagePack-CSharp
...
public static class Probe
{
    ...
    // V4 Serialize<T> shape: stackalloc scratch (SkipLocalsInit omitted — this project
    ...
    // V4 formatter shape: generic method instantiated over a ByRefLike type
    [MethodImpl(MethodImplOptions.NoInlining)]
    ...
    // resolver shape shared by V4 (pre-bypass) and MessagePack-CSharp
