...
// try/finally in MessagePackSerializer.Serialize<T> cost anything at runtime?
...
public class EntryTryFinallyCostBenchmark
{
    ...
    public void Setup()
    {
        ...
        var expectedPoco = V3::MessagePack.MessagePackSerializer.Serialize(person);
        var expectedArray = V3::MessagePack.MessagePackSerializer.Serialize(values);
