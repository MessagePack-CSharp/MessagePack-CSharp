...
/// <summary>
/// Every struct implementing IWriteBuffer/IReadBuffer (or the async flavors) is
...
{
    public const string DiagnosticId = "UMP103";
        ...
        context.RegisterCompilationStartAction(static startContext =>
        {
            var interfaces = ImmutableArray.CreateRange(
                new[]
                {
                    ...
                    "SerializerFoundation.IAsyncWriteBuffer",
                    "SerializerFoundation.IAsyncReadBuffer",
                }
