// MsgPack104: this benchmark A/Bs direct buffer calls against the resolver-formatter route; the direct calls are the benchmarked subject.
...
public class DateTimeFormatterDispatchBenchmark
{
    ...
    public void Setup()
    {
        SourceGeneratedFormatterFactory.Instance.Register(typeof(DtFused), new DtFusedFormatterFactory());
        SourceGeneratedFormatterFactory.Instance.Register(typeof(DtVia), new DtViaFormatterFactory());
        SourceGeneratedFormatterFactory.Instance.Register(typeof(DtViaFlag), new DtViaFlagFormatterFactory());
        SourceGeneratedFormatterFactory.Instance.Register(typeof(DtFlagFused), new DtFlagFusedFormatterFactory());
    ...
    where TReadBuffer : struct, IReadBuffer, allows ref struct
{
    ...
    {
        dt = resolver.GetFormatter<TWriteBuffer, TReadBuffer, DateTime>();
        isDefaultDateTime = dt is MessagePack.Formatters.DateTimeFormatter<TWriteBuffer, TReadBuffer>;
    }
