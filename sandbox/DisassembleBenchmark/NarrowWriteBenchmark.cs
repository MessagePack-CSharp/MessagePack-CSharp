...
public class NarrowWriteByteBenchmark
{
    ...
    public int ViaUInt32()
    {
        ...
        {
            pos += MessagePack.MessagePackPrimitives.UnsafeWriteUInt32(ref Unsafe.Add(ref d, pos), vals[i]);
        }
        return pos;
    }
...
public class NarrowWriteSByteBenchmark
{
    ...
    public int ViaInt32()
    {
        ...
        for (int i = 0; i < vals.Length; i++)
        {
            pos += MessagePack.MessagePackPrimitives.UnsafeWriteInt32(ref Unsafe.Add(ref d, pos), vals[i]);
        }
        return pos;
    }
