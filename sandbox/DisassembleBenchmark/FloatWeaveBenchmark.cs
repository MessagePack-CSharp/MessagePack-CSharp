...
public class FloatWeaveBenchmark
{
    ...
    public void Setup()
    {
        ...
        var oracle = V3::MessagePack.MessagePackSerializer.Serialize(fdata);
...
public static class FloatWeaveCandidates
{
    ...
    public static int WriteFloatRegionScalar(ref byte d, ref float src, int length)
    {
        ...
        {
            o += MessagePack.MessagePackPrimitives.UnsafeWriteSingle(ref Unsafe.Add(ref d, o), Unsafe.Add(ref src, i));
        }
        return o;
    }
    ...
    public static int WriteDoubleRegionScalar(ref byte d, ref double src, int length)
    {
        ...
        for (int i = 0; i < length; i++)
        {
            o += MessagePack.MessagePackPrimitives.UnsafeWriteDouble(ref Unsafe.Add(ref d, o), Unsafe.Add(ref src, i));
        }
        return o;
    }
