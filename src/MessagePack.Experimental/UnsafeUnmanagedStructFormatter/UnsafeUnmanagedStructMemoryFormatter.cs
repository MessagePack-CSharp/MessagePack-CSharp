...
{
    public sealed unsafe class UnsafeUnmanagedStructMemoryFormatter<T> : IMessagePackFormatter<Memory<T>>
        where T : unmanaged
    {
...
#pragma warning restore SA1401 // Fields should be private
        ...
        public UnsafeUnmanagedStructMemoryFormatter(sbyte typeCode)
        {
            TypeCode = typeCode;
        }
