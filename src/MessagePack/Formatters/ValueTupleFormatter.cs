...
namespace MessagePack.Formatters
{
    ...
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1> value, MessagePackSerializerOptions options)
        {
    ...
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1, T2> value, MessagePackSerializerOptions options)
        {
    ...
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1, T2, T3> value, MessagePackSerializerOptions options)
        {
    ...
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1, T2, T3, T4> value, MessagePackSerializerOptions options)
        {
    ...
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5> value, MessagePackSerializerOptions options)
        {
    ...
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5, T6> value, MessagePackSerializerOptions options)
        {
    ...
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5, T6, T7> value, MessagePackSerializerOptions options)
        {
    ...
    public sealed class ValueTupleFormatter<T1, T2, T3, T4, T5, T6, T7, TRest> : IMessagePackFormatter<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>
        where TRest : struct
    {
        public void Serialize(in MessagePackWriter writer, ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> value, MessagePackSerializerOptions options)
        {
