...
namespace MessagePack.Formatters
{
    public class Int16Formatter : IMessagePackFormatter<Int16>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Int16 value)
        {
            return MessagePackBinary.WriteInt16(ref bytes, offset, value);
        }

        public Int16 Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class Int32Formatter : IMessagePackFormatter<Int32>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Int32 value)
        {
    ...
    public class Int64Formatter : IMessagePackFormatter<Int64>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Int64 value)
        {
    ...
    public class UInt16Formatter : IMessagePackFormatter<UInt16>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, UInt16 value)
        {
            return MessagePackBinary.WriteUInt16(ref bytes, offset, value);
        }

        public UInt16 Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class UInt32Formatter : IMessagePackFormatter<UInt32>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, UInt32 value)
        {
            return MessagePackBinary.WriteUInt32(ref bytes, offset, value);
        }

        public UInt32 Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class UInt64Formatter : IMessagePackFormatter<UInt64>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, UInt64 value)
        {
            return MessagePackBinary.WriteUInt64(ref bytes, offset, value);
        }

        public UInt64 Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class SingleFormatter : IMessagePackFormatter<Single>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Single value)
        {
            return MessagePackBinary.WriteSingle(ref bytes, offset, value);
        }

        public Single Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class DoubleFormatter : IMessagePackFormatter<Double>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Double value)
        {
            return MessagePackBinary.WriteDouble(ref bytes, offset, value);
        }

        public Double Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class BooleanFormatter : IMessagePackFormatter<Boolean>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Boolean value)
        {
            return MessagePackBinary.WriteBoolean(ref bytes, offset, value);
        }

        public Boolean Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class SByteFormatter : IMessagePackFormatter<SByte>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, SByte value)
        {
            return MessagePackBinary.WriteSByte(ref bytes, offset, value);
        }

        public SByte Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class CharFormatter : IMessagePackFormatter<Char>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Char value)
        {
            return MessagePackBinary.WriteChar(ref bytes, offset, value);
        }

        public Char Deserialize(byte[] bytes, int offset, out int readSize)
        {
    ...
    public class DateTimeFormatter : IMessagePackFormatter<DateTime>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, DateTime value)
        {
