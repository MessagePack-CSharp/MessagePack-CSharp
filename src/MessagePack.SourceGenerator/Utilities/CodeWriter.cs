...
sealed class CodeWriter
{
    ...
    /// <summary>
    /// The common head of every generated file: the auto-generated marker (analyzers skip the file), a blanket
    /// warning disable, and the nullable annotation context the emitted signatures rely on (its warnings stay off
    /// through the pragma). The pragma lists no ids: the consumer's warning set differs per SDK, analyzer package
    /// and project (TreatWarningsAsErrors included), and a list rots (v3's never covered the CS0219 that leaked once).
    /// GeneratedCodeWarningTests strips the pragma and re-compiles, so emitted code is still held warning-free here.
    /// </summary>
    public CodeWriter FileHeader()
    {
        Line("// <auto-generated/>");
        Line("#pragma warning disable");
        Line("#nullable enable annotations");
        return this;
    }
