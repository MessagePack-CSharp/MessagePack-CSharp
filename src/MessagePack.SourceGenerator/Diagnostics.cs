...
{
    // MsgPack0xx = generator pipeline diagnostics (this class)
    // MsgPack1xx = standalone DiagnosticAnalyzers under Analyzers

    // {0} carries the whole pre-formatted message: keeps DiagnosticInfo equatable without dragging object[] args through the pipeline
