...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 9 "C:\Users\y.kawai\Documents\neuecc\MessagePack-CSharp\src\MessagePack.CodeGenerator\Generator\FormatterTemplate.tt"
 ...
 if(0 <= x.IntKey && x.IntKey <= 127) { 
            ...
            #line default
            #line hidden
            this.Write(" \r\n            offset += global::MessagePack.MessagePackBinary.WritePositiveFixed" +
                    "IntUnsafe(ref bytes, offset, ");
 ...
 if( objInfo.IsClass) { 
            ...
            #line hidden
            this.Write("            }\r\n\r\n            var startOffset = offset;\r\n            var length = " +
                    "global::MessagePack.MessagePackBinary.ReadMapHeader(bytes, offset, out readSize)" +
                    ";\r\n            offset += readSize;\r\n\r\n");
 ...
 if(objInfo.IsStringKey) { 
            ...
            #line default
            #line hidden
            this.Write(@"                var stringKey = global::MessagePack.MessagePackBinary.ReadString(bytes, offset);
                offset += readSize;
                int key;
...
");
            ...
            #line default
            #line hidden
            this.Write("                var key = global::MessagePack.MessagePackBinary.ReadInt32(bytes, " +
                    "offset, out readSize);\r\n                offset += readSize;\r\n");
