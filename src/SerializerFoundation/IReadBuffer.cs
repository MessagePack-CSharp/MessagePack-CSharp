...
/// Inspect bytes through <see cref="GetUnreadSpan"/> or <see cref="TryGetSpan"/>, then consume them with <see cref="Advance"/>.
/// A span obtained from either stays valid until the next call to <see cref="GetUnreadSpan"/> or <see cref="TryGetSpan"/>,
...
public interface IReadBuffer : IDisposable
{
    ...
    /// Never throws.
    /// The span is valid until the next <see cref="GetUnreadSpan"/> or <see cref="TryGetSpan"/> call, or Dispose.
    /// </summary>
