...
");
            ...
            this.Write("();\r\n\r\n");
 if( UnboundGenericInfo.Length > 0 ){ 
            this.Write("        static readonly Dictionary<Type, Type> genericTypeDefToFormatterTypeDef =" +
                    " new Dictionary<Type, Type>( ");
            this.Write(this.ToStringHelper.ToStringWithCulture(UnboundGenericInfo.Length));
            this.Write(" )\r\n        {\r\n");
 for(var i = 0; i < UnboundGenericInfo.Length; i++) { 
    string emptyAngularBrackets = UnboundGenericInfo[ i ].TemplateParametersEmpty;

            this.Write("            { typeof( ");
            this.Write(this.ToStringHelper.ToStringWithCulture(UnboundGenericInfo[ i ].FullNameNoGenericParams));
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(emptyAngularBrackets));
            this.Write("), \r\n                typeof( ");
            this.Write(this.ToStringHelper.ToStringWithCulture(UnboundGenericInfo[ i ].FormatterName.StartsWith("global::") ? UnboundGenericInfo[ i ].FormatterName: (!string.IsNullOrEmpty(FormatterNamespace) ? FormatterNamespace + "." : FormatterNamespace) + 
                    UnboundGenericInfo[ i ].FormatterName));
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(emptyAngularBrackets));
            this.Write(" ) },\r\n\r\n");
 } 
            this.Write("            };\r\n\r\n            static Dictionary<Type, object> closedGenericFormat" +
                    "terCache = new Dictionary<Type, object>();\r\n\r\n");
 } 
            this.Write("        private ");
            this.Write(this.ToStringHelper.ToStringWithCulture(ResolverName));
            this.Write("()\r\n        {\r\n        }\r\n\r\n        public global::MessagePack.Formatters.IMessag" +
                    "ePackFormatter<T> GetFormatter<T>()\r\n        {\r\n");
 if( UnboundGenericInfo.Length == 0 ){ 
            this.Write("            return FormatterCache<T>.Formatter;\r\n");
 } else{ 
            this.Write(@"            global::MessagePack.Formatters.IMessagePackFormatter<T> formatter =
...
");
            ...
            this.Write("        }\r\n\r\n        private static class FormatterCache<T>\r\n        {\r\n         " +
                    "   internal static readonly global::MessagePack.Formatters.IMessagePackFormatter" +
